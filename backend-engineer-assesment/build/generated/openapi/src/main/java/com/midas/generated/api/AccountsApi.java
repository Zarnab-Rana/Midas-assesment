...
public interface AccountsApi {
     ...
     * updates the user account with the given details.
     *
    ...
    @Operation(
        ...
        description = "updates the user account with the given details.",
        tags = { "Accounts" },
        responses = {
            @ApiResponse(responseCode = "200", description = "User account updated", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AccountDto.class))
            }),
            @ApiResponse(responseCode = "400", description = "Bad request", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class))
    ...
    default ResponseEntity<AccountDto> updateUserAccount(
        ...
        @Parameter(name = "UpdateAccountDto", description = "User account details", required = true) @Valid @RequestBody UpdateAccountDto updateAccountDto
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
